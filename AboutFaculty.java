...
class AboutFaculty extends JFrame implements ActionListener{
	     private JTextField tf;
		 private FacultyPortal sp;
	
	public AboutFaculty (FacultyPortal t){
		super(" My Info");
		sp=t;
	...
	public void actionPerformed(ActionEvent ae){
		...
		try {
			...
			ResultSet rs= st.executeQuery("select * from faculty where password='"+tf.getText()+"';");
