...
class FacultyPortal extends JFrame implements ActionListener{
	           
              private FacultyLogin sl;
			   MenuBar mb;
			   Menu FileMenu,EditMenu,SearchMenu,ViewMenu;
	           MenuItem save,saveas,print,open,exit;
			    MenuItem aboutme;
				private AboutFaculty as;
			   
			   
	          public FacultyPortal(FacultyLogin al){
		   super("Faculty PORTAL");
		
		          sl=al;
				  as=new AboutFaculty(this);
