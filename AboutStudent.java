...
class AboutStudent extends JFrame implements ActionListener{
	     private JTextField tf;
		 private StudentPortal sp;
	
	
	public AboutStudent (StudentPortal t){
		super(" My Info");
		sp=t;
	...
	public void actionPerformed(ActionEvent ae){
		...
		try {
			...
			ResultSet rs= st.executeQuery("select * from student where password='"+tf.getText()+"';");
